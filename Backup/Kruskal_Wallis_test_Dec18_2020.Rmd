...
- The results of Fligner Killeen test shows that __`PChoice` and `Self_Est`__ __do not have equal variance__ across the four groups. __The rest of variables__ have __equal variance__ across the groups.
