...
- Correlation Table for Publication
```{r echo=FALSE}
table_1 <- gui_cluster_data %>%
  select(age, frequency_coded, commitment_coded, number_programs, SOC, SoCoh, IMI, IM, PComp, PChoice, Self_Est, Self_Eff #, CNS, RC1, RC2, clusters
