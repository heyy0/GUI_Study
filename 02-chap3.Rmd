...
```{r results="hide"}
model_gui_1 <- lm(SOC ~ number_programs + commitment_coded + frequency_coded, data = only_gui_scales)
summary(model_gui_1) # Significant only in the number of program types

model_gui_2 <- lm(IMI ~ frequency_coded + commitment_coded + number_programs, data = only_gui_scales)
summary(model_gui_2) # Significant only in the number of program types
```
