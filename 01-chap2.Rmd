...
a1 <- gui_mar20_scales %>%
  ...
  ggplot(aes(x = gui_non_gui, y = SoCoh, fill = gui_non_gui)) +
  geom_boxplot() +
  theme(legend.position = "None") +
  labs(x = "Visited GUI Before", y = "Social Cohesion")
a2 <- gui_mar20_scales %>%
  select(SOC, gui_non_gui) %>%
  ggplot(aes(x = gui_non_gui, y = SOC, fill = gui_non_gui)) +
  geom_boxplot() +
  theme(legend.position = "None") +
  labs(x = "Visited GUI Before", y = "Sense of Community")
a3 <- gui_mar20_scales %>%
  select(CNS, gui_non_gui) %>%
  ggplot(aes(x = gui_non_gui, y = CNS, fill = gui_non_gui)) +
  geom_boxplot() +
  theme(legend.position = "None") +
  labs(x = "Visited GUI Before", y = "Connection to Nature")
a4 <- gui_mar20_scales %>%
  select(Self_Eff, gui_non_gui) %>%
  ggplot(aes(x = gui_non_gui, y = Self_Eff, fill = gui_non_gui)) +
  geom_boxplot() +
  theme(legend.position = "None") +
  labs(x = "Visited GUI Before", y = "Self Efficacy")
a5 <- gui_mar20_scales %>%
  select(Self_Est, gui_non_gui) %>%
  ggplot(aes(x = gui_non_gui, y = Self_Est, fill = gui_non_gui)) +
  geom_boxplot() +
  theme(legend.position = "None") +
  labs(x = "Visited GUI Before", y = "Self Esteem")
```
