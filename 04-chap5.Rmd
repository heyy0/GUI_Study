...
tibble(
  "GUI Benefits" = c(
    "Restoration", "Nature Connection", "Sense of Community", "Empowerment", "Environmental Awareness", "Hands-on Experiences", "Mindsets (related to 5G)", "Self-Confidence", "Self-awareness"
  ),
  "Cosine Similarity" = c(0.586, 0.629, 0.696, 0.271, 0.151, "0.130", 0.523, 0.395, "NA*")
) %>%
  gt() %>%
  tab_header(
