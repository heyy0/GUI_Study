...
tibble(
  ...
  gt() %>%
  tab_header(
    title = "GUI Benefits: Correlation Test Results"
  ) %>%
  tab_source_note(
...
tibble(
  ...
  gt() %>%
  tab_header(
    title = "GUI Values: Correlation Test Results"
  ) %>%
  tab_source_note(
    source_note = "* denotes non significant correlation"
  )
...
# Values 
## 1) Characteristics of Nature in GUI
...
## 2) Sense of Autonomy and Ownership
