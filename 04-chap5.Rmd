...
dfm(corp, remove_punct = TRUE , remove = c(stopwords("english"), "yeah", "uh", "it’s", "you’re", "there’s", "i’m", "don’t", "i’ve", "you’ve", "that’s", "things", "cos", "er", "erm", "everyone’s", "lo", "lor", "ah", "we’re", "um", "also")
    ) %>%
